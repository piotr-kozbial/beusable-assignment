...
class BookingOptimizerGenerativeTest {
	...
	var instance = new BookingOptimizer.ProblemInstance(
            arguments.freePremiumRooms(),
            arguments.freeEconomyRooms(),
            arguments.clientOffers());
    ...
    private void checkNoUpgradesIfEconomyBelowCapacity(
